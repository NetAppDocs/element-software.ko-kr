...
TIP: 관련 클러스터 임계값에 대한 자세한 내용은 Element API를 참조하십시오 link:../api/reference_element_api_getclusterfullthreshold.html["“getClusterFullThreshold”"] 요소 소프트웨어 API 설명서에서 _. 블록 및 메타데이터 용량에 대한 자세한 내용은 를 참조하십시오  요소 소프트웨어 설명서 _.
