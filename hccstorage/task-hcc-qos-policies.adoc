...
NOTE: 사용에 대한 자세한 내용은 SolidFire All-Flash 스토리지 개념 내용 을 참조하십시오 link:../concepts/concept_data_manage_volumes_solidfire_quality_of_service.html#qos-policies["QoS 정책"] 개별 볼륨 대신 .
