...
[role="lead"]
복제 관계를 생성하려면 먼저 SnapMirror 엔드포인트를 생성해야 합니다. 이 작업은 Element 소프트웨어 웹 UI에서만 수행할 수 있습니다. link:../api/reference_element_api_abortsnapmirrorrelationship.html["SnapMirror API 메소드"].
