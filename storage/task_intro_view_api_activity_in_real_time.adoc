...
각 방법에 대한 정보는 다음을 참조하세요. link:../api/concept_element_api_about_the_api.html["Element 소프트웨어 API 참조입니다"].
...
* link:../api/concept_element_api_about_the_api.html["Element API를 사용하여 스토리지 관리"]
